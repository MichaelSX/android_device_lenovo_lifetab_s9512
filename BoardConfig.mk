...
TARGET_KERNEL_CONFIG	:= omni_lifetab_s9512_defconfig
TARGET_PREBUILT_KERNEL	:= device/lenovo/lifetab_s9512/kernel
BOARD_KERNEL_CMDLINE	:= console=none omapboot=emmc init=/init vram=20M omapfb.vram=0:16M androidboot.console=ttyO2 androidboot.serialno=FD00014482 androidboot.serialno2=11S11014484ZZ10025G0VS androidboot.bootloader=U-Boot_1.1.4 twl6030.condition=0x801 twl6030.pwoff=0x80E3FB07 android.pwroff_chg=false androidboot.bootmode=normal
